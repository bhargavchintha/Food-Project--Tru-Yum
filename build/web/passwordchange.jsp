...
<%
    ...
    try {
        ...
        stmt = conn.prepareStatement("SELECT password FROM signu WHERE email = ?");
        ...
        if (rs.next()) {
            ...
            if (password != null && password.equals(passwordFromDatabase)) {
                stmt = conn.prepareStatement("UPDATE signu SET password = ? WHERE email = ?");
                ...
                <script>
                    window.onload = function() {
                        var messageElement = document.getElementById("update");
                ...
                <%
                // response.sendRedirect("passwordchange.jsp?message=Password successfully updated");
            } else if (password != null && !password.equals(passwordFromDatabase)) {
                %>
                <div id="popupMessage" class="popup-message">
                ...
                <script>
                    window.onload = function() {
                        var messageElement = document.getElementById("Not-update");
                        var message = "Password update failed. Incorrect current password";
                ...
                <%
                // response.sendRedirect("passwordchange.jsp?message=Password update failed. Incorrect current password");
            }
        } else {
            %>
            <div id="popupMessage" class="popup-message">
            ...
            <%
            // response.sendRedirect("passwordchange.jsp?message=User not found");
        }
    } catch (Exception e) {
        e.printStackTrace();
        // If error occurred while updating the password
        %>
        <div id="popupMessage" class="popup-message">
...
%>
        ...
        <title> Password Change | TruYum Restaurant </title>
    ...
    <link rel="stylesheet" type="text/css" href="./password-change.css">
...
<div class="Password" >
            <div class="password-1">
                <div class="password-2">
                    <h1 class="cpassword">Change Your Password</h1>
                    <div class="inputs">
                        <form action="passwordchange.jsp" method="post"  onsubmit="return validateForm()"   >
                        ...
                        <div id="Not-update" class="Not-update"></div>
                        </form>
                        
                       <!-- <div class="back-home">
                            <button class="btn" > <a class="Backhome" href="Home.jsp"><span  class="arrow"  ><i class="fas fa-arrow-left"></i></span>&nbsp;
                                Back to Home
                                </a></button>
                        </div>-->
 ...
 <script>
    function validateForm() {
        ...
        if (newPassword.length < 8) {
            messageDiv.innerText = "Password should be at least 8 characters long";
            return false;
