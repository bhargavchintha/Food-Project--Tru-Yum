...
<link rel="icon" href="images/TRU-YUM.png">
    ...
    <title> Vegetarian | TruYum Restaurant </title>
    ...
    <div id="button-container">
      <div class="conta">
        ...
        <div class="hai">
          <div class="grilled">
            <div class="grilled-1">
                <a class="LINK-h1" href="VEG/Veg-Keema.jsp">  <h1 class="grilled-h1">
                Veg Keema Curry
                    </h1></a>
              <p class="grilled-p">
               Veg keema has the delightful spicy flavours of the matar keema with the nutritious goodness of vegetables. This recipe uses minced mushroom, beans, cauliflower and carrot to resemble the minced texture of keema.
              </p>
              <div class="grilled-2">
                <div class="grilled-3">

                <div class="img-hidden">
                    <a href="VEG/Veg-Keema.jsp">  <img class="grilled-img" src="images/VEG/VEG-keema.jpg"></a>
                    <div class="img-price-name">
                      <div class="img-price-name-1">
                        ...
                        <p class="price-grilled">
                          <i class="fa fa-rupee"></i> 140 (Include all taxs)
                        </p>
                               ...
                               padding-top: 20px;
                                ...
                                img.grilled-img {
                                 ...
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="VEG.jsp" method="post">
                                        <input type="hidden" name="itemid" value="V-1" /><!-- V means VEG -->
                                        <input type="hidden" name="itemname" value="Veg Keema Curry" />
                                        <input type="hidden" name="itemprice" value="140" />
                                        <input type="hidden" name="image" value="images/VEG/VEG-keema.jpg" />
                                        <input type="hidden" name="link" value="VEG/Veg-Keema.jsp" />
        ...
        <div class="hai">
          <div class="grilled">
            <div class="grilled-1">
                <a class="LINK-h1" href="VEG/Veg_Biryani.jsp"> <h1 class="grilled-h1">
                Veg Biryani
                 </h1></a>
              <p class="grilled-p">
              ...
              <div class="grilled-2">
                ...
                <div class="img-hidden">
                    <a href="VEG/Veg_Biryani.jsp">  <img class="grilled-img" src="images/VEG/Veg-Biryani.jpg"></a>
                    <div class="img-price-name">
                      <div class="img-price-name-1">
                        <h1 class="name-grilled">
                          Veg Biryani
                        ...
                        <div class="add-cart-order-btn">
                                 ...
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="VEG.jsp" method="post">
                                        <input type="hidden" name="itemid" value="V-2" /><!-- V means VEG -->
                                        <input type="hidden" name="itemname" value="Veg Biryani" />
                                        <input type="hidden" name="itemprice" value="170" />
                                        <input type="hidden" name="image" value="images/VEG/Veg-Biryani.jpg" />
                                        <input type="hidden" name="link" value="VEG/Veg_Biryani.jsp" />
                                        <button class="Add-cart-grilled" type="submit" name="addToCart">Add to Cart</button>
                                    </form>
                                </div>
        ...
        <div class="hai">
          <div class="grilled">
            <div class="grilled-1">
                <a class="LINK-h1" href="VEG/Kale_Channe_Ki_Biryani.jsp"> <h1 class="grilled-h1">
              ...
              <div class="grilled-2">
                ...
                <div class="img-hidden">
                    <a href="VEG/Kale_Channe_Ki_Biryani.jsp">  <img class="grilled-img" src="images/VEG/Kale-Channe-Ki-Biryani.jpg"></a>
                    <div class="img-price-name">
                      <div class="img-price-name-1">
                        <h1 class="name-grilled">
                          Kale Channe Ki Biryani
                        ...
                        <p class="price-grilled">
                          <i class="fa fa-rupee"></i> 179 (Include all taxs)
                        </p>
                        <div class="add-cart-order-btn">
                                 ...
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="VEG.jsp" method="post">
                                        <input type="hidden" name="itemid" value="V-3" /><!-- V means VEG -->
                                        <input type="hidden" name="itemname" value="Kale Channe Ki Biryani" />
                                        <input type="hidden" name="itemprice" value="179" />
                                        <input type="hidden" name="image" value="images/VEG/Kale-Channe-Ki-Biryani.jpg" />
                                        <input type="hidden" name="link" value="VEG/Kale_Channe_Ki_Biryani.jsp" />
                                        <button class="Add-cart-grilled" type="submit" name="addToCart">Add to Cart</button>
                                    </form>
                                </div>
        ...
        <div class="hai">
          <div class="grilled">
            <div class="grilled-1">
                <a class="LINK-h1" href="VEG/Kathal_Biryani.jsp"> <h1 class="grilled-h1">
                Kathal Biryani
                 </h1></a>
              <p class="grilled-p">
               A flavorsome biryani  with the goodness of kathal (jack-fruit) and the aroma of garlic, coriander, turmeric and garam masala.
              </p>
              <div class="grilled-2">
                <div class="grilled-3">

                <div class="img-hidden">
                    <a href="VEG/Kathal_Biryani.jsp">  <img class="grilled-img" src="images/VEG/Kathal-Biryani.jpg"></a>
                    <div class="img-price-name">
                      <div class="img-price-name-1">
                        <h1 class="name-grilled">
                          Kathal Biryani
                        ...
                        <div class="add-cart-order-btn">
                                 ...
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="VEG.jsp" method="post">
                                        <input type="hidden" name="itemid" value="V-4" /><!-- V means VEG -->
                                        <input type="hidden" name="itemname" value=" Kathal Biryani" />
                                        <input type="hidden" name="itemprice" value="140" />
                                        <input type="hidden" name="image" value="images/VEG/Kathal-Biryani.jpg" />
                                        <input type="hidden" name="link" value="VEG/Kathal_Biryani.jsp" />
                                        <button class="Add-cart-grilled" type="submit" name="addToCart">Add to Cart</button>
                                    </form>
                                </div>
        ...
        <div class="hai">
          <div class="grilled">
            <div class="grilled-1">
                <a class="LINK-h1" href="VEG/Makhni_Paneer_Biryani.jsp"> <h1 class="grilled-h1">
                Makhni Paneer Biryani
                 </h1></a>
              <p class="grilled-p">
               Fried paneer cubes doused in a luscious creamy gravy, layered with rice and cooked 'dum' style.
              </p>
              <div class="grilled-2">
                <div class="grilled-3">

                <div class="img-hidden">
                    <a href="VEG/Makhni_Paneer_Biryani.jsp">  <img class="grilled-img" src="images/VEG/Makhni-Paneer-Biryani.jpg"></a>
                    <div class="img-price-name">
                      <div class="img-price-name-1">
                        <h1 class="name-grilled">
                          Makhni Paneer Biryani
                        ...
                        <p class="price-grilled">
                          <i class="fa fa-rupee"></i> 170 (Include all taxs)
                        </p>
                        <div class="add-cart-order-btn">
                                 ...
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="VEG.jsp" method="post">
                                        <input type="hidden" name="itemid" value="V-5" /><!-- V means VEG -->
                                        <input type="hidden" name="itemname" value="Makhni Paneer Biryani" />
                                        <input type="hidden" name="itemprice" value="165" />
                                        <input type="hidden" name="image" value="images/VEG/Makhni-Paneer-Biryani.jpg" />
                                        <input type="hidden" name="link" value="VEG/Makhni_Paneer_Biryani.jsp" />
                                        <button class="Add-cart-grilled" type="submit" name="addToCart">Add to Cart</button>
                                    </form>
                                </div>
                  ...
                  <div class="escalope">
                    <div class="escalope-name">
                      <p class="escalope">
                        A perfect biryani recipe for vegetarians and a paneer lover's delight!
                      </p>
                    </div>
                  </div>
