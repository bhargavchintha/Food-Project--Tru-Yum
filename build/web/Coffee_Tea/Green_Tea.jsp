<%-- 
    Document   : Green_Tea
    Created on : Jun 5, 2023, 2:45:14 PM
    Author     : Bhargav
--%>
<!DOCTYPE html>
<html>
    <head>
        <title>Green Tea | TruYum Restaurant | All Food Items</title>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">Green Tea</h2>  
                </div>
              <div class="Grid_Coffee">
                   <div class="IMG-Visible_Grid">
                       <img class="Black_Coffee" src="../images/Coffee-Tea/Green-Tea.jpg" alt="Green Tea" />
                   </div>
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                          Green tea, renowned for its numerous health benefits, is made from unoxidized leaves of the Camellia sinensis plant.
                          Rich in antioxidants and nutrients, it promotes heart health, aids in weight loss, and boosts metabolism. With a delicate 
                          flavor profile ranging from grassy to sweet, green tea is enjoyed worldwide as a refreshing and soothing beverage. Whether 
                          enjoyed hot or cold, it's a popular choice for those seeking a natural way to enhance their well-being.
                       </p>
                       
                       <div class="Add-Cart-Order-Btn-Process">
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="Green_Tea.jsp" method="post" class="ng-pristine ng-valid">
                                        <input type="hidden" name="itemid" value="NCT-6" /><!-- NCT of means Coffee-Tea -->
                                ...
                                <div class="cart-items">
                                       <!-- Add to Order Form -->
                                       <form action="Green_Tea.jsp" method="post">
                                            <input type="hidden" name="itemid" value="NCT-6" /><!-- NCT of means Coffee-Tea -->
                                            <input type="hidden" name="itemname" value="Green Tea" />
                                            <input type="hidden" name="itemprice" value="45" />
                                            <input type="hidden" name="image" value="images/Coffee-Tea/Green-Tea.jpg" />
