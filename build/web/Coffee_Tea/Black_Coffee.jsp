<%-- 
    Document   : Black_Coffee
    Created on : Jun 5, 2023, 2:19:40 PM
    Author     : Bhargav
--%>
<!DOCTYPE html>
<html>
    <head>
        <title>Black Coffee | TruYum Restaurant | All Food Items</title>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">Black Coffee</h2>  
                </div>
              <div class="Grid_Coffee">
                   <div class="IMG-Visible_Grid">
                       <img class="Black_Coffee" src="../images/Coffee-Tea/Black-Coffee.jpg" alt="Black_Coffee" />
                   </div>
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                           Black coffee is simply coffee that is normally brewed without the addition of additives such as sugar, milk, cream, or 
                       ...
                       <div class="Add-Cart-Order-Btn-Process">
                                 <div class="cart-items">
                                    ...
                                    <form action="Black_Coffee.jsp" method="post" class="ng-pristine ng-valid">
                                        <input type="hidden" name="itemid" value="NCT-1" autocomplete="off"><!-- CT of means Coffee-Tea -->
                                        <input type="hidden" name="itemname" value="Black Coffee" autocomplete="off">
                                        <input type="hidden" name="itemprice" value="50" autocomplete="off">
                                        <input type="hidden" name="image" value="images/Coffee-Tea/Black-Coffee.jpg" autocomplete="off">
                                        <input type="hidden" name="link" value="Coffee_Tea/Black_Coffee.jsp" autocomplete="off">
