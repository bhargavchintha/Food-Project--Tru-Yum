<%-- 
    Document   : Black_Tea
    Created on : Jun 5, 2023, 2:57:53 PM
    Author     : Bhargav
--%>
...
<html>
    <head>
        <title>Black Tea | TruYum Restaurant | All Food Items</title>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">Black Tea</h2>  
                </div>
              <div class="Grid_Coffee">
                   <div class="IMG-Visible_Grid">
                       <img class="Black_Coffee" src="../images/Coffee-Tea/Black-Tea.jpg" alt="Black_Tea" />
                   </div>
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                           Black tea, known for its bold flavor and dark hue, undergoes full oxidation during processing. Rich in antioxidants, 
                           it offers health benefits such as improved heart health and enhanced immunity. With a higher caffeine content compared
                           to other teas, it provides a natural energy boost. Enjoyed hot or cold, black tea offers a timeless and invigorating beverage 
                       ...
                       <div class="Add-Cart-Order-Btn-Process">
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="Black_Tea.jsp" method="post" class="ng-pristine ng-valid">
                                        <input type="hidden" name="itemid" value="NCT-2" /><!-- NCT of means Coffee-Tea -->
