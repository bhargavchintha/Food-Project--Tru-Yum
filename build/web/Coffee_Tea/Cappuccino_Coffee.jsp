<%-- 
    Document   : Cappuccino-Coffee
    Created on : Jun 5, 2023, 1:54:10 PM
    Author     : Bhargav
--%>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">Cappuccino</h2>  
                </div>
              <div class="Grid_Coffee">
                   <div class="IMG-Visible_Grid">
                       <img class="Black_Coffee" src="../images/Coffee-Tea/Cappuccino-Coffee.jpg" alt="Cappuccino_Coffee" />
                   </div>
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                           Cappuccino, an Italian coffee classic, features equal parts espresso, steamed milk, and foam. Its 
                           rich espresso base is balanced by the creamy texture of milk foam, creating a delightful contrast of 
                           flavors and textures. Traditionally served in a small cup, Cappuccino is enjoyed for its bold flavor 
                           and frothy finish. With its origins dating back to 17th century Italy, it remains a beloved choice for 
                       ...
                       <div class="Add-Cart-Order-Btn-Process">
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="Cappuccino_Coffee.jsp" method="post" class="ng-pristine ng-valid">
                                        <input type="hidden" name="itemid" value="NCT-4" /><!-- NCT of means Coffee-Tea -->
                                ...
                                <div class="cart-items">
                                       <!-- Add to Order Form -->
                                       <form action="Cappuccino_Coffee.jsp" method="post">
                                            <input type="hidden" name="itemid" value="NCT-4" /><!-- NCT of means Coffee-Tea -->
                                            <input type="hidden" name="itemname" value="Cappuccino" />
                                            <input type="hidden" name="itemprice" value="167" />
                                            <input type="hidden" name="image" value="images/Coffee-Tea/Cappuccino-Coffee.jpg" />
