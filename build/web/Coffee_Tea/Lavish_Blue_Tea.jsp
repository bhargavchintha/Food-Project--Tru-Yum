<%-- 
    Document   : Lavish_Blue_Tea
    Created on : Jun 5, 2023, 3:05:21 PM
    Author     : Bhargav
--%>
<!DOCTYPE html>
<html>
    <head>
        <title>Lavish Blue Tea | TruYum Restaurant | All Food Items</title>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">Lavish Blue Tea</h2>  
                </div>
              <div class="Grid_Coffee">
                   ...
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                          Lavish Blue Tea, also known as butterfly pea flower tea, is crafted from the vibrant petals of the Clitoria ternatea plant. 
                          With its striking blue hue, this herbal tea offers a visually stunning experience. Renowned for its potential health benefits, 
                          including antioxidant properties and stress-relieving effects, it's cherished for both its taste and aesthetic appeal. Whether 
                          enjoyed hot or cold, Lavish Blue Tea offers a delightful sensory journey for tea enthusiasts.
                       </p>
                       ...
                       <div class="Add-Cart-Order-Btn-Process">
                                 <div class="cart-items">
                                    ...
                                    <form action="Lavish_Blue_Tea.jsp" method="post" class="ng-pristine ng-valid">
                                        <input type="hidden" name="itemid" value="NCT-7" /><!-- NCT of means Coffee-Tea -->
                                ...
                                <div class="cart-items">
                                       <!-- Add to Order Form -->
                                       <form action="Lavish_Blue_Tea.jsp" method="post">
                                             <input type="hidden" name="itemid" value="NCT-7" /><!-- NCT of means Coffee-Tea -->
                                            <input type="hidden" name="itemname" value="Lavish Blue Tea" />
                                            <input type="hidden" name="itemprice" value="75" />
                                            <input type="hidden" name="image" value="images/Coffee-Tea/Lavish-Blue-Tea.jpg" />
