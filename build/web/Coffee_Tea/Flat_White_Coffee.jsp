<%-- 
    Document   : Flat_White_Coffee
    Created on : Jun 5, 2023, 2:28:06 PM
    Author     : Bhargav
--%>
<!DOCTYPE html>
<html>
    <head>
        <title>Flat White Coffee | TruYum Restaurant | All Food Items</title>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">Flat White Coffee</h2>  
                </div>
              <div class="Grid_Coffee">
                   <div class="IMG-Visible_Grid">
                       <img class="Black_Coffee" src="../images/Coffee-Tea/Flat-White-Coffee.jpg" alt="Flat_White_Coffee" />
                   </div>
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                           Flat White Coffee, originating from Australia or New Zealand, is a smooth and velvety espresso-based beverage. 
                           It's characterized by its creamy texture, achieved by mixing microfoam with a double shot of espresso. The milk 
                           is steamed to a silky consistency, creating a balanced flavor profile that highlights the richness of the coffee. 
                           With its subtle sweetness and delicate foam, Flat White is a favorite among those who appreciate a milder coffee experience.
                       </p>
                       
                       <div class="Add-Cart-Order-Btn-Process">
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="Flat_White_Coffee.jsp" method="post" class="ng-pristine ng-valid">
                                        <input type="hidden" name="itemid" value="NCT-5" /><!-- NCT of means Coffee-Tea -->
                                ...
                                <div class="cart-items">
                                       <!-- Add to Order Form -->
                                       <form action="Flat_White_Coffee.jsp" method="post">
                                            <input type="hidden" name="itemid" value="NCT-5" /><!-- NCT of means Coffee-Tea -->
                                            <input type="hidden" name="itemname" value="Flat White Coffee" />
                                            <input type="hidden" name="itemprice" value="85" />
                                            <input type="hidden" name="image" value="images/Coffee-Tea/Flat-White-Coffee.jpg" />
