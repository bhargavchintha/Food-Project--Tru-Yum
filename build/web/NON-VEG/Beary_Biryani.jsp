<%-- 
    Document   : Beary_Biryani
    Created on : May 26, 2023, 11:57:44 AM
    Author     : Bhargav
--%>
<!DOCTYPE html>
<html>
    <head>
        <title> Beary Biryani | TruYum Restaurant | All Food Items</title>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">Beary Biryani</h2>  
                </div>
              <div class="Grid_Coffee">
                   <div class="IMG-Visible_Grid">
                       <img class="Black_Coffee" src="../images/Non-VEG/Beary-Biryani.png" alt="Ambur_Biryani" />
                   </div>
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                           Beary Biryani is a delectable dish originating from the Beary Muslim community of coastal Karnataka, India.
                           Made with fragrant Basmati rice, tender meat (commonly chicken or mutton), and a unique blend of aromatic spices,
                           including cloves, cinnamon, and nutmeg, it offers a rich and flavorful taste experience. The dish is cooked using 
                           the Dum method, where the ingredients are layered and slow-cooked to perfection, allowing the flavors to infuse 
                           harmoniously. Garnished with fried onions, mint leaves, and roasted cashews, Beary Biryani is served with accompaniments 
                           like raita, pickle, and salad, adding texture and freshness to every bite. It's a culinary delight cherished for its rich 
                           cultural heritage and tantalizing flavors.
                       </p>
                       
                       <div class="Add-Cart-Order-Btn-Process">
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="Beary_Biryani.jsp" method="post" class="ng-pristine ng-valid">
                                        <input type="hidden" name="itemid" value="NNV-2" autocomplete="off"><!-- CT of means Coffee-Tea -->
                                ...
                                <div class="cart-items">
                                       ...
                                       <form action="NON-VEG.jsp" method="post">
                                             <input type="hidden" name="itemid" value="NNV-2" /><!-- NV means NON-VEG -->
                                            <input type="hidden" name="itemname" value="Beary Biryani" />
                                            <input type="hidden" name="itemprice" value="275" />
                                            <input type="hidden" name="image" value="images/Non-VEG/Beary-Biryani.png" />
                                            <input type="hidden" name="link" value="NON-VEG/Beary_Biryani.jsp"/>
