<%-- 
    Document   : Userinfo
    Created on : Jun 4, 2023, 2:41:29 PM
    Author     : Bhargav
--%>
...
<div class="criterion">
  ...
  <div class="text text8"><%= FullName%></div>
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    var animationDuration = 7800; // Adjust this value as needed
...
// Call preventBack function after the page has finished loading
window.addEventListener("load", function() {
  preventBack();

  // Get the back-page button element
  var backButton = document.querySelector(".back-page");

  // Add a click event listener to the back-page button
  backButton.addEventListener("click", function() {
    // Clear the unload event handler to allow navigating back
