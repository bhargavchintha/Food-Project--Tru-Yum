<%-- 
    Document   : Ambur_Biryani
    Created on : May 26, 2023, 11:08:11 AM
    Author     : Bhargav
--%>
<!DOCTYPE html>
<html>
    <head>
        <title> Ambur Biryani | TruYum Restaurant | All Food Items</title>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">Ambur Biryani</h2>  
                </div>
              <div class="Grid_Coffee">
                   <div class="IMG-Visible_Grid">
                       <img class="Black_Coffee" src="../images/Non-VEG/Ambur-Biryani.png" alt="Ambur_Biryani" />
                   </div>
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                           Ambur Biryani is a traditional South Indian dish renowned for its aromatic flavors and tender meat. 
                           Prepared using Basmati rice, marinated meat (often chicken or mutton), and a blend of spices such as cloves, 
                           cardamom, and cinnamon, it offers a tantalizing taste experience. The dish is cooked using the Dum method, where 
                           the ingredients are layered and slow-cooked to perfection, allowing the flavors to meld together. Garnished with 
                           fried onions, coriander leaves, and a squeeze of lemon, Ambur Biryani promises a delightful culinary journey. Served 
                           with accompaniments like raita, brinjal curry, and boiled eggs, it's a cherished favorite among biryani enthusiasts.
                       </p>
                       
                       <div class="Add-Cart-Order-Btn-Process">
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="Ambur_Biryani.jsp" method="post" class="ng-pristine ng-valid">
                                        <input type="hidden" name="itemid" value="NNV-1" autocomplete="off">
                                         <input type="hidden" name="itemname" value="Ambur Biryani" />
                                ...
                                <div class="cart-items">
                                       <!-- Add to Order Form -->
                                       <form action="Ambur_Biryani.jsp" method="post">
                                            <input type="hidden" name="itemid" value="NNV-1" />
                                            <input type="hidden" name="itemname" value="Ambur Biryani" />
                                            <input type="hidden" name="itemprice" value="220" />
                                            <input type="hidden" name="image" value="images/Non-VEG/Ambur-Biryani.png" />
                                            <input type="hidden" name="link" value="NON-VEG/Ambur_Biryani.jsp"/>
