<%-- 
    Document   : Natu Kodi Kura
    Created on : May 25, 2023, 6:26:13 PM
    Author     : Bhargav
--%>
...
<html>
    <head>
        <title> Natu Kodi Curry | TruYum Restaurant | All Food Items</title>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">Natu Kodi Curry</h2>  
                </div>
              <div class="Grid_Coffee">
                   <div class="IMG-Visible_Grid">
                       <img class="Black_Coffee" src="../images/Non-VEG/Natu-Kodi-Kura.jpg" alt="Ambur_Biryani" />
                   </div>
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                           Natu Kodi Kura is a traditional Andhra-style chicken curry renowned for its bold flavors and spicy taste. 
                           Prepared using free-range or country chicken (Natu Kodi), this dish features tender chicken pieces cooked 
                           in a rich gravy infused with aromatic spices like coriander, cumin, curry leaves, and red chilies. Additionally, 
                           ingredients such as ginger, garlic, onions, and tomatoes are used to enhance the depth of flavor. The curry is 
                           typically finished with a tempering of mustard seeds, cumin seeds, and curry leaves to impart a final burst of aroma. 
                           Natu Kodi Kura is often served hot with steamed rice, roti, or paratha, making it a favorite comfort food among lovers 
                       ...
                       <div class="Add-Cart-Order-Btn-Process">
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="Natu_Kodi_Kura.jsp" method="post" class="ng-pristine ng-valid">
                                        <input type="hidden" name="itemid" value="NNV-3" autocomplete="off"><!-- CT of means Coffee-Tea -->
                                ...
                                <div class="cart-items">
                                       <!-- Add to Order Form -->
                                       <form action="Natu_Kodi_Kura.jsp" method="post">
                                            <input type="hidden" name="itemid" value="NNV-3" /><!-- NV means NON-VEG -->
                                            <input type="hidden" name="itemname" value="Natu Kodi Kura" />
                                            <input type="hidden" name="itemprice" value="280" />
                                            <input type="hidden" name="image" value="images/Non-VEG/Natu-Kodi-Kura.jpg" />
                                            <input type="hidden" name="link" value="NON-VEG/Natu_Kodi_Kura.jsp" />
