<%-- 
    Document   : Vanilla_Iced_Coffee
    Created on : Jun 5, 2023, 2:17:18 PM
    Author     : Bhargav
--%>
<!DOCTYPE html>
<html>
    <head>
        <title>Vanilla Iced Coffee | TruYum Restaurant | All Food Items</title>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">Vanilla Iced Coffee</h2>  
                </div>
              <div class="Grid_Coffee">
                   <div class="IMG-Visible_Grid">
                       <img class="Black_Coffee" src="../images/Coffee-Tea/Vanilla-Iced-Coffee.jpg" alt="Lavish_Blue_Tea" />
                   </div>
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                          Vanilla Iced Coffee is a refreshing beverage made by combining chilled coffee with creamy vanilla syrup and milk, served over ice. 
                          It offers a delightful balance of bold coffee flavor and sweet vanilla undertones, perfect for cooling down on a hot day. This indulgent 
                          treat is often garnished with whipped cream or a sprinkle of cinnamon for added richness. With its smooth texture and enticing aroma, Vanilla 
                          Iced Coffee is a beloved choice for coffee lovers seeking a cool and satisfying pick-me-up.
                       </p>
                       ...
                       <div class="Add-Cart-Order-Btn-Process">
                                 <div class="cart-items">
                                    ...
                                    <form action="Lavish_Blue_Tea.jsp" method="post" class="ng-pristine ng-valid">
                                        <input type="hidden" name="itemid" value="NCT-8" /><!-- NCT of means Coffee-Tea -->
