<%-- 
    Document   : White_Tea
    Created on : Jun 5, 2023, 2:36:26 PM
    Author     : Bhargav
--%>
<!DOCTYPE html>
<html>
    <head>
        <title>White Tea | TruYum Restaurant | All Food Items</title>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">White Tea</h2>  
                </div>
              <div class="Grid_Coffee">
                   <div class="IMG-Visible_Grid">
                       <img class="Black_Coffee" src="../images/Coffee-Tea/White-Tea.jpg" alt="White Tea" />
                   </div>
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                          White tea is a delicate and subtle variety known for its light flavor and pale appearance. Made from young tea leaves and buds, 
                          it undergoes minimal processing, preserving its natural antioxidants and nutrients. With its gentle taste and floral undertones, 
                          white tea offers a soothing and refreshing experience. Often enjoyed for its potential health benefits, including boosting the immune 
                          system and promoting relaxation, white tea is a cherished choice for those seeking a milder alternative to other tea varieties.
                       </p>
                       
                       <div class="Add-Cart-Order-Btn-Process">
                                 <div class="cart-items">
                                    <!-- Add to Cart Form -->
                                    <form action="Lavish_Blue_Tea.jsp" method="post" class="ng-pristine ng-valid">
                                        <input type="hidden" name="itemid" value="NCT-9" /><!-- NCT of means Coffee-Tea -->
                                ...
                                <div class="cart-items">
                                       ...
                                       <form action="Coffee-Tea.jsp" method="post">
                                            <input type="hidden" name="itemid" value="NCT-9" /><!-- CT of means Coffee-Tea -->
                                            <input type="hidden" name="itemname" value="White Tea" />
                                            <input type="hidden" name="itemprice" value="65" />
                                            <input type="hidden" name="image" value="images/Coffee-Tea/White-Tea.jpg" />
                                            <input type="hidden" name="link" value="Coffee_Tea/White_Tea.jsp" />
