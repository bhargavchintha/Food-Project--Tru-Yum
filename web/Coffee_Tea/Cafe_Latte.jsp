<%-- 
    Document   : Cafe_Latte
    Created on : Jun 5, 2023, 3:18:25 PM
    Author     : Bhargav
--%>
<!DOCTYPE html>
<html>
      ...
      <div class="Balck-Coffee">
          <div class="Img-Balck_coffee">
                <div class="Balck-Coffee_Text">
                    <h2 class="Black_text">Cafe Latte</h2>  
                </div>
              <div class="Grid_Coffee">
                   <div class="IMG-Visible_Grid">
                       <img class="Black_Coffee" src="../images/Coffee-Tea/Cafe-Latte.jpg" alt="Cafe_Latte" />
                   </div>
                   <div class="Matter_Grid">
                       <p class="About_Coffee">
                           Café Latte, a classic espresso-based beverage, combines espresso with steamed milk and a layer of frothed milk. Its smooth and 
                           creamy texture makes it a popular choice among coffee enthusiasts. With a perfect balance of bold espresso and velvety milk, 
                           Café Latte offers a delightful coffee experience. Often served in a ceramic cup, it's a comforting and indulgent treat enjoyed worldwide.
                       </p>
